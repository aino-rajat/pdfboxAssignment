...
public class DrawPrintTextLocation {

	public static class DrawPrintTextLocations extends PDFTextStripper
	{
	    ...
	    public static void main(String[] args) throws IOException
	    {
	        ...
	        else
	        {
	            ...
	            {
	                DrawPrintTextLocations stripper = new DrawPrintTextLocations(document,inputPath);
